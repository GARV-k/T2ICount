...
(Tips: You could try 1e-4 for learning rate, 1e-4 for weight decay if you couldn't get nice results with lr=5e-5. It will quickly get you a nice model on the original validation/test set)
