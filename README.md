...
(Tips: You could try 1e-4 for learning rate if you couldn't get nice results with lr=5e-5. You could also try to reduce the weight_decay to 5e-5. We have tested the reproducibility of this code and obtained consistent results, the [training log](https://github.com/cha15yq/T2ICount/blob/main/log/train.log) is provided along with the [reproduced model](https://drive.google.com/file/d/1VN5uI9F0XjKQ-JwjOpMYYJF5ku92znO_/view?usp=sharing).)
```
